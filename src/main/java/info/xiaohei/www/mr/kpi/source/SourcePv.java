...
public class SourcePv {
    public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException {
        ...
        JobInitModel job = new JobInitModel(inPath, outPath, conf, null, jobName
                , SourcePv.class, null, Mapper.class, Text.class, IntWritable.class, null, Reducer.class
                , Text.class, IntWritable.class);

        JobInitModel sortJob = new JobInitModel(new String[]{outPath + "/part-*"}, outPath + "/sort", conf, null
                , jobName + "sort", SourcePv.class, null, Mapper.class, Text.class, IntWritable.class, null, null, null, null);
